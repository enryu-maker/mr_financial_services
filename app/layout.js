...
export const metadata = {
  ...
  keywords: ["Loan Consultant Nashik", "Home Loan Nashik", "Business Loan Nashik", "Financial Services Nashik", "Real Estate Nashik", "Tax Consultant Nashik", "Mortgage Loan Nashik", "M.R. Financial Services"],
  ...
  openGraph: {
    ...
    url: "https://mrfinancial.in", // Replace with actual URL if known
...
export default function RootLayout({ children }) {
  const jsonLd = {
    ...
    "image": "https://mrfinancial.in/assets/MR_LOGO.png", // Replace with actual URL
